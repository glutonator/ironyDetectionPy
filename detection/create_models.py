...
def get_all_models_gpu(total_length, max_sentence_length):
    ...
    models.append(di_gpu.give_model_10_7(total_length, max_sentence_length))
    ...
    models.append(di_gpu.give_model_40_2(total_length, max_sentence_length))

    models.append(di_gpu.give_model_50(total_length, max_sentence_length))
    models.append(di_gpu.give_model_50_2(total_length, max_sentence_length))
    models.append(di_gpu.give_model_60(total_length, max_sentence_length))
    models.append(di_gpu.give_model_60_2(total_length, max_sentence_length))

    models.append(di_gpu.give_model_41(total_length, max_sentence_length))
    models.append(di_gpu.give_model_41_2(total_length, max_sentence_length))
    models.append(di_gpu.give_model_61(total_length, max_sentence_length))
    models.append(di_gpu.give_model_61_2(total_length, max_sentence_length))
    #
    models.append(di_gpu.give_model_50000(total_length, max_sentence_length))
    models.append(di_gpu.give_model_50000_2(total_length, max_sentence_length))
    models.append(di_gpu.give_model_50001(total_length, max_sentence_length))
    models.append(di_gpu.give_model_50001_2(total_length, max_sentence_length))
